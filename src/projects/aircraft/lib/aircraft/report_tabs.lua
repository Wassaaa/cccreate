...
local function configSections(config)
  ...
  table.insert(display, row("display.rotorValues", "absolute", "Rotor Nixies show actuator magnitudes. A contiguous 3+ Nixie strip is auto-reserved for throttle/H/T status when scan finds one."))
