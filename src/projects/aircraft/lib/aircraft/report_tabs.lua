...
local function configSections(config)
  ...
  add(orientation, config, "level.gravity", "Saved neutral gravity vector used as the zero attitude target.")
  ...
  add(controller, config, "controller.axis1Sign", "Controller roll input sign. Flip if A/D request the wrong roll direction.", "aircraft config controller-signs 1 1")
  add(controller, config, "controller.axis2Sign", "Controller pitch input sign. Flip if W/S request the wrong pitch direction.")
